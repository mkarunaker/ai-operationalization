...
export function checkHumanVoice(input: unknown): VoiceCheck {
  ...
  return { riskPercent, label: scoreLabel(riskPercent), findings, disclaimer: "This is an explainable pattern check, not an AI-authorship detector. A higher score means the draft contains more common AI-like writing patterns worth revising." };
}
