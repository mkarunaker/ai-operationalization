...
import { liveRunPreview, rerunLiveReviewer, runLiveEditorialRun } from "@/editorial/live-run";
...
export async function POST(
  ...
  try {
    ...
    if (body.action === "create_linkedin_companion")
      return Response.json({ idea: createLinkedinCompanion(ideaId) });
    ...
    if (body.action === "create_visual_companion")
      return Response.json({ idea: createVisualCompanion(ideaId) });
